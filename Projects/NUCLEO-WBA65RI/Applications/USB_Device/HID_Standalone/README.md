...
enumerated as a HID device using the native PC Host HID driver to which the NUCLEO-WBA65RI
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA65RI board Set-up
    - Connect the NUCLEO-WBA65RI board CN9 to the PC through "TYPE-C" to "Standard A" cable.
