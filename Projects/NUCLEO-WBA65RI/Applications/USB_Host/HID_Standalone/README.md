...
USB host application based on the Human Interface Class (HID) on the STM32WBA65XX devices.

This is a typical application on how to use the STM32WBA65xx USB OTG Host peripheral to interact with an USB
...
- Level of debug: USBH_DEBUG_LEVEL
   ...
   messages to uart terminal, stm32WBA65xx_hal_uart.c driver needs to be added to the application sources.
