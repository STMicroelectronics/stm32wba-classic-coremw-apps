...
USB host application based on the Communication Class (CDC) on the STM32WBA65XX devices.

This is a typical application on how to use the STM32WBA56xx USB OTG Host peripheral to operate with an USB
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA65RI Set-up
    ...
    - Plug the USB key into the NUCLEO-WBA65RI board through 'USB Type C-Male
