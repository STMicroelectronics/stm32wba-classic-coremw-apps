...
USB host application based on the Communication Class (CDC) on the STM32WBA25XX devices.

This is a typical application on how to use the STM32WBA25xx USB OTG Host peripheral to operate with an USB
...
                  3: All messages and internal debug messages are shown\
  ...
  messages to uart terminal, stm32wbaxx_hal_uart.c driver needs to be added to the application sources.\
...
### <b>Directory contents</b>
    ...
    - USB_Host/CDC_Standalone/Core/Src/system_stm32wbaxx.c            STM32WBAxx  system clock configuration File
    - USB_Host/CDC_Standalone/Core/Src/stm32wbaxx_it.c                Interrupt handlers
    - USB_Host/CDC_Standalone/Core/Src/stm32wbaxx_hal_msp.c           HAL MSP Module
    - USB_Host/CDC_Standalone/Core/Inc/main.h                         Main program header File
    - USB_Host/CDC_Standalone/Core/Inc/stm32wbaxx_hal_conf.h          HAL configuration File
    - USB_Host/CDC_Standalone/Core/Inc/stm32wbaxx_it.h                Interrupt handlers header File
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-WBA25CE boards revision: MB2293-WBA2-B01
    and can be easily tailored to any other supported device and development board.

  - NUCLEO-WBA25CE Set-up

    - JP4 must be connected (USB_C position) to provide power to VBUS and to the connected USB device.
      When JP4 is ON, the VBUS LED (LD4) turns on to indicate that power is provided to CN9.

    - Plug the USB key into the NUCLEO-WBA25CE board through 'USB Type C-Male
  ...
  - The UART1 communication between the target MCU and ST-LINK MCU is enabled. It's configuration is as following:
    - BaudRate = 115200 baud
    - Word Length = 8 Bits
    - Stop Bit = 1
    - Parity = None
