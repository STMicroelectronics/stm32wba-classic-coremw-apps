...
USB host application based on the Human Interface Class (HID) on the STM32WBA25XX devices.

This is a typical application on how to use the STM32WBA25XX USB OTG Host peripheral to interact with an USB
...
The High Speed (HS) USB module uses a 48-MHz clock, which is generated from HSE.
...
                  3: All messages and internal debug messages are shown\
   ...
   messages to uart terminal, STM32WBA25XX_hal_uart.c driver needs to be added to the application sources.\
...
### <b>Directory contents</b>
    ...
    - USB_Host/HID_Standalone/Core/Src/system_stm32wbaxx.c            STM32wbaxx  system clock configuration File
    - USB_Host/HID_Standalone/Core/Src/stm32wbaxx_it.c                Interrupt handlers
    - USB_Host/HIS_Standalone/Core/Src/stm32wbaxx_hal_msp.c           HAL MSP Module
    - USB_Host/HID_Standalone/Core/Inc/main.h                         Main program header File
    - USB_Host/HID_Standalone/Core/Inc/stm32wbaxx_hal_conf.h          HAL configuration File
    - USB_Host/HID_Standalone/Core/Inc/stm32wbaxx_it.h                Interrupt handlers header File
